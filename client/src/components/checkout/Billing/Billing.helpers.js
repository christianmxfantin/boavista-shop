...
export const saveNewAddress = async (formValues, user) => {
  ...
  if (country.data.message === "El nombre de País ingresado está disponible.") {
  ...
  if (state.data.message === "El nombre de Estado ingresado está disponible.") {
  ...
  if (city.data.message === "El nombre de Ciudad ingresado está disponible.") {
