...
export const products = {
  1: { id: 1, name: "Lapicera Bic x 24 unidades", price: 500, stock: 1200 },
  2: {
    id: 2,
  ...
  6: { id: 6, name: "Compáses Pizzini x 12 unidades", price: 900, stock: 1200 },
  7: { id: 7, name: "Compáses Pizzini x 12 unidades", price: 900, stock: 1200 },
  8: {
    id: 8,
    name: "Lápices Staedtler x 24 unidades",
    price: 500,
